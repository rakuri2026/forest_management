...
from ..models.yearly_activities import PotentialActivity, ProposedYearlyActivity, ActivityYearDetail
...
async def list_potential_activities(
    ...
    query = query.order_by(
        PotentialActivity.display_order,
        PotentialActivity.project_name,
        PotentialActivity.progarms,
        PotentialActivity.activities
    )
