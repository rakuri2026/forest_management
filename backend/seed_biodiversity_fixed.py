"""
Seed biodiversity_species table from CSV files (fixed version)
...
# Disable SQLAlchemy logging to avoid Unicode errors
import logging
...
def main():
    ...
    try:
        ...
        if existing_count > 0:
            print(f"\nWARNING: Database already contains {existing_count} species")
